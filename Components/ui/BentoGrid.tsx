...
export const BentoGridItem = ({
	...
	const handleCopy = () => {
		const text = "sayudhrk1919@gmail.com";
		...
		>
			...
			<div className={`${id === 6 && "flex justify-center"} h-full`}>
				...
				>
					...
					{/* Tech stack list div */}
					{id === 3 && (
						<div className="flex gap-1 lg:gap-5 absolute -right-3 lg:-right-2 top-0 h-full py-4 overflow-y-auto overflow-x-hidden custom-scrollbar pr-3">
							{/* tech stack lists */}
